...
class ValMeter:
    ...
    def __init__(self, max_iter, cfg):
        ...
        self.all_labels = []
        self.output_dir = cfg.OUTPUT_DIR
        self.corrected_epoch_top1_err = None #基于错误累积的top1_err的初始化
        self.corrected_epoch_top5_err = None #基于错误累积的top5_err的初始化
    ...
    def update_stats(self, top1_err, top5_err, mb_size):
        ...
        self.mb_top1_err.add_value(top1_err)
        self.mb_top5_err.add_value(top5_err)
        self.num_top1_mis += top1_err * mb_size #利用top1_err和样本数来计算出来有多少错误的数据
        self.num_top5_mis += top5_err * mb_size
        self.num_samples += mb_size
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        #top1_err = self.num_top1_mis / self.num_samples#计算方法
        
        top1_err = (
        self.corrected_epoch_top1_err 
        if self.corrected_epoch_top1_err is not None
        else self.num_top1_mis / self.num_samples
        )

        top5_err = self.num_top5_mis / self.num_samples
        self.min_top1_err = min(self.min_top1_err, top1_err)#min_top1_err本质就是取top1_err的最小值

...
class Imagenet(torch.utils.data.Dataset):
    ...
    def _construct_imdb(self):
        ...
        self._class_ids = sorted(f for f in split_files if re.match(r"^[A-z]+[1-9]+$", f))
    ...
    def _prepare_im(self, im_path):
        ...
        if self.mode == "train":
            ...
            logger.info(f'Train Transform:{aug_transform}')
        else:
            t = []
            ...
            logger.info(f'Val Transform:{aug_transform}')
        im = aug_transform(im)
        return im
